...
import io.github.tedtedted.craigslist.exception.CraigslistHttpException;
import io.github.tedtedted.craigslist.exception.CraigslistNetworkException;
import io.github.tedtedted.craigslist.exception.CraigslistNotFoundException;
import io.github.tedtedted.craigslist.exception.CraigslistRateLimitException;
import io.github.tedtedted.craigslist.exception.CraigslistServerException;
import io.github.tedtedted.craigslist.exception.CraigslistTimeoutException;
...
/**
 * GETs Craigslist URLs with retry, rate limiting, and exception mapping. Returns Jsoup {@link
 * Document} instances with the request URI set as the base so relative links resolve correctly.
 */
