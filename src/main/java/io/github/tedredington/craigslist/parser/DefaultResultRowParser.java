...
/** Default search-row parser. Tries modern Craigslist selectors first
 *  ({@code li.cl-search-result}, {@code li.cl-static-search-result}) and falls
 *  back to the legacy {@code li.result-row} layout. */
public class DefaultResultRowParser implements ResultRowParser {
    ...
    public Listing parseRow(Element row) {
        ...
        Element titleAnchor = firstNonNull(
