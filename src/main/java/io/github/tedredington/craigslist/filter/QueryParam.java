...
/** A single key/value pair for the Craigslist search URL. Builders accumulate these
 *  and the URI builder emits them as percent-encoded query-string fragments. */
