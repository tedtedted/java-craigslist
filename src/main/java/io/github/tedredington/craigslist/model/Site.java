...
/** A Craigslist regional site (subdomain). This is a curated initial set covering
 *  the most-used metropolitan areas. The full ~450-site list is intended to be
 *  generated and committed via the {@code generateSiteEnums} build task;
 *  see {@code tools/codegen/README.md}. */
public enum Site {
    ...
    /** The DNS subdomain used to address this site (e.g. {@code "sfbay"} for
     *  {@code sfbay.craigslist.org}). */
