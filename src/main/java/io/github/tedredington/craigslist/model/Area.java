...
/** A sub-area within a {@link Site} (e.g. {@code Area.SFC} = San Francisco proper
 *  inside {@code Site.SF_BAY}). Curated initial set; full list is intended to be
 *  generated and committed via the {@code generateSiteEnums} task. */
public enum Area {
    // SF Bay
    ...
    public static Optional<Area> byCode(Site site, String code) {
        return Arrays.stream(values())
                .filter(a -> a.site == site && a.code.equals(code))
                .findFirst();
    }
}
