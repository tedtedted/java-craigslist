...
public final class CraigslistForSale extends CraigslistBase {
    ...
    public static final class Builder extends BaseBuilder<CraigslistForSale, Builder> {
        ...
        public CraigslistForSale build() {
            ...
            if (minPrice != null) params.add(new QueryParam(FilterKeys.MIN_PRICE, Integer.toString(minPrice)));
            if (maxPrice != null) params.add(new QueryParam(FilterKeys.MAX_PRICE, Integer.toString(maxPrice)));
            if (conditions != null) {
