...
/**
 * Assembles Craigslist search URLs of the form {@code
 * https://{site}.craigslist.org/search/{area?}/{category}?...&s=offset}. Tests can supply a base
 * URI override (e.g. {@code http://localhost:8080}) to target a {@code MockWebServer} instead of
 * the live site.
 */
public final class UriBuilder {
  ...
  public URI buildSearch(
      Site site, Optional<Area> area, CategoryCode category, List<QueryParam> params, int offset) {
