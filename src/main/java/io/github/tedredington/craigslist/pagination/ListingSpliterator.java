package io.github.tedredington.craigslist.pagination;
...
/** Drives lazy, sequential pagination across Craigslist search pages. Each call to
 *  {@link #tryAdvance(Consumer)} drains a per-page buffer; when the buffer is empty
 *  it fetches the next page until either the result cap is hit or an empty page is
 *  returned. Not splittable. */
