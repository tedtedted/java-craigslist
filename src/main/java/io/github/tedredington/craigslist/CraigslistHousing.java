...
import io.github.tedredington.craigslist.model.Laundry;
import io.github.tedredington.craigslist.model.Parking;
import io.github.tedredington.craigslist.model.Pets;
import io.github.tedredington.craigslist.model.Site;
import io.github.tedredington.craigslist.parser.HousingResultRowParser;
import io.github.tedredington.craigslist.parser.ResultRowParser;
import java.util.List;

/** Search Craigslist housing listings (apartments, rooms, sublets, real estate, …).
 *  Each instance is immutable and reusable. Iterate it to retrieve listings. */
public final class CraigslistHousing extends CraigslistBase {
    ...
    /** Builder for housing queries. Exposes housing-specific filters in addition to
     *  the base setters inherited from {@link BaseBuilder}. */
    public static final class Builder extends BaseBuilder<CraigslistHousing, Builder> {
        ...
        public CraigslistHousing build() {
            ...
            if (Boolean.TRUE.equals(privateRoom)) params.add(new QueryParam(FilterKeys.PRIVATE_ROOM, "1"));
            if (Boolean.TRUE.equals(privateBath)) params.add(new QueryParam(FilterKeys.PRIVATE_BATH, "1"));
