...
import io.github.tedredington.craigslist.http.HttpFetcher;
import io.github.tedredington.craigslist.http.RateLimiter;
import io.github.tedredington.craigslist.http.RetryPolicy;
import io.github.tedredington.craigslist.http.UriBuilder;
import java.net.URI;
import java.net.http.HttpClient;
import java.time.Duration;
import java.util.Optional;

/** Entry point to the library. Construct with {@link #create()} for sensible defaults
 *  or with {@link #builder()} for full control over HTTP behavior. Thread-safe; intended
 *  to be a long-lived singleton. Implements {@link AutoCloseable} so it can be used in
 *  try-with-resources to release the underlying {@link HttpClient}.
 *
...
public final class Craigslist implements AutoCloseable {
    ...
    public static final String DEFAULT_USER_AGENT =
            "java-craigslist/0.1 (+https://github.com/tedredington/java-craigslist)";
    ...
    public static final class Builder {
        ...
        /** Supply a pre-built {@link HttpClient}. Otherwise one is created with the
        ...
        /** Override the base URI used to build search URLs. Intended for tests
         *  (e.g. pointing at a {@code MockWebServer}). When set, URLs take the form
         *  {@code <baseUriOverride>/_/<siteSubdomain>/search/...}. */
