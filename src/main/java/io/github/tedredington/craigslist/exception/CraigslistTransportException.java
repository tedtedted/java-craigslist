...
/** Base type for any network or HTTP failure. Catch this if you want a single
 *  catch-all for transport problems without discriminating between timeouts,
 *  connection errors, and HTTP status errors. */
