...
/** Thrown when the underlying transport fails before an HTTP response was received
 *  (DNS resolution, connection refused, socket I/O, etc.). The original
 *  {@link java.io.IOException} is preserved as the cause. */
