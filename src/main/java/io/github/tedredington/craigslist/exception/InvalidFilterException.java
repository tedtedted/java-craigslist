...
/** Thrown when a filter value fails validation (range violation, area/site mismatch,
 *  missing required field, etc.). Carries the offending field name and value so callers
 *  can build user-facing error messages without parsing strings. */
