...
/**
 * Thrown when the HTML returned by Craigslist could not be parsed at the page level (no result-row
 * elements and no "no results" marker, or {@code totalcount} unparseable). Individual malformed
 * rows are skipped and warn-logged, not thrown.
 */
public class CraigslistParsingException extends CraigslistException {
  ...
  public CraigslistParsingException(String message, URI sourceUri, String html, Throwable cause) {
